...
for (x, y, w, h) in fa:
    ...
    if final == 0:
        cv2.putText(image, "BAT",(x+10,y+h+ 30), fontface, 1, (0,255,0),2)
    if final == 1:
        cv2.putText(image, "S.Tung",(x+10,y+h+ 30), fontface, 1, (0,255,0),2)
    if final == 2:
        cv2.putText(image, "Hai Tu",(x+10,y+h+ 30), fontface, 1, (0,255,0),2)
    if final == 3:
        cv2.putText(image, "Den Vau",(x+10,y+h+ 30), fontface, 1, (0,255,0),2)
